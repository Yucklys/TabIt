import svgPaths from "./svg-8cbxbja4km";
...
function GroupingMode() {
  return (
    <div className="absolute bg-[rgba(236,236,240,0.5)] h-[49px] left-[31px] rounded-[200px] top-[513px] w-[357px]" data-name="Grouping Mode">
      ...
      <p className="absolute font-['Arial:Regular',_sans-serif] leading-[20px] left-[calc(50%-68.5px)] not-italic text-[14px] text-neutral-950 text-nowrap top-[14px] whitespace-pre">See Grouping Results</p>
    </div>
  );
}
