import svgPaths from "./svg-0uspu3qvsd";
...
function Input() {
  return (
    <div className="absolute bg-white h-[52px] left-0 rounded-[8px] top-[24px] w-[356px]" data-name="Input">
...
function Container() {
  return (
    <div className="absolute h-[77px] left-0 top-0 w-[356px]" data-name="Container">
      <PrimitiveLabel />
      <Input />
    </div>
  );
...
function PromptTemplate() {
  return (
    <div className="absolute h-[77px] left-[31px] overflow-clip top-[97px] w-[356px]" data-name="PromptTemplate">
      <Container />
    </div>
  );
}
    ...
    <div className="h-[85px] relative rounded-[8px] shrink-0 w-full" data-name="Textarea">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[85px] items-start px-[12px] py-[8px] relative w-full">
          <p className="font-['Arial:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[#717182] text-[12px] w-[330px]">e.g., Keep social media tabs separate, merge all news sites</p>
        </div>
      </div>
